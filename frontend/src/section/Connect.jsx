        ...
        <RevealSection>
          ...
          <div style={{ display: "flex", gap: "3rem", flexWrap: "wrap", alignItems: "flex-start" }}>
            ...
            <div style={{ flex: 1, minWidth: "280px" }}>
              ...
              <a href="/resume.pdf" download style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", padding: "0.75rem 1.5rem", borderRadius: "8px", background: "rgba(124,111,212,0.12)", border: `1px solid ${ACCENT2}`, color: ACCENT2, fontSize: "14px", fontWeight: 600, textDecoration: "none", cursor: "pointer" }}>
